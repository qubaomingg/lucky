			...
			<header>
				<div>
					...
					<ul>
						...
						<li><a id="write_update" <?php  if(isset($article)): ?>href="<?php echo $baseUrl."master/update/$detailid"?>"<?php endif;?>>><img src="<?php echo $baseUrl."img/back_modify.png"?>" alt="modify"></a></li>
				...
				<aside>
					<div id="about_design">
						...
						<ul>
							...
							<li data-type="1" data-value="2014" class="time"><a href="">2014 年</a></li>
							<li data-type="1" data-value="2015" class="time"><a href="">2015 年</a></li>
							<li data-type="1" data-value="2016" class="time"><a href="">2016 年</a></li>
						</ul>
					</div>
					<div id="about_me">
						...
						<ul>
							...
							<li data-type="2" data-value="2014" class="time"><a href="">2014 年</a></li>
							<li data-type="2" data-value="2015" class="time"><a href="">2015 年</a></li>
							<li data-type="2" data-value="2016" class="time"><a href="">2016 年</a></li>
						</ul>
					</div>
					<div id="about_road">
						...
						<ul>
							...
							<li data-type="3" data-value="2014" class="time"><a href="">2014 年</a></li>
							<li data-type="3" data-value="2015" class="time"><a href="">2015 年</a></li>
							<li data-type="3" data-value="2016" class="time"><a href="">2016 年</a></li>
						</ul>
					</div>
				</aside>
					...
					<div class="back_article">
						<article >
							<div class="back_article_header">
								...
								<time><?php echo $article[0]['atime']?> <?php if($article[0]) :?>｜<?php endif;?><?php echo $article[0]['anum']?></time>
							</div>
							<section>
